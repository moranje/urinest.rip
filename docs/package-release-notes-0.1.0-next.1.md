...
| `@beslismodel/cvrm-prevent` | `packages/cvrm-prevent` | `724ca45016dbe9330c486a6ff7fbe8e1d98cef136688776b7ba8f3f90dab5cf3` |
...
```bash
BESLISMODEL_REGISTRY_SMOKE_VERSION=0.1.0-next.1 npm run check:package-registry-smoke
```

## Migration

1. Publish all seven packages with dist-tag `next`.
2. Run registry smoke with exact version `0.1.0-next.1`.
...
- Keep Gitea tag `beslismodel-v0.1.0-next.1` tied to this release note.
